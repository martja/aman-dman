...
import org.example.view.tabpage.timeline.labels.ArrivalLabel
import org.example.view.tabpage.timeline.labels.DepartureLabel
import org.example.view.tabpage.timeline.labels.TimelineLabel
...
class TimelineOverlay(
    ...
    private fun updateFlightLabels() {
        val currentCallsigns = timelineState.timelineOccurrences.mapNotNull { it.getFlight()?.callsign }
        ...
        timelineState.timelineOccurrences.forEach { timelineOccurrence ->
